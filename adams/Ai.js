const {
  adams
} = require("../Ibrahim/adams"); const puter = require("puter.js"); const config = require("../config");
...
adams( {
  ...
  const {
    repondre
  } = commandOptions; const prefix = config.PREFIX || "!"; let helpText = "🤖 VeilWolf-AI Commands\n\nAvailable Models:\n"; Object.entries(models).forEach(([name, model]) => {
      helpText += • *$ {
        prefix
      }$ {
        name
    ...
    prefix
  }resetai` to clear memory.`; await repondre(helpText);
});
